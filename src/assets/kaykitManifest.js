export const KAYKIT_ASSETS = [
  {
    ...
    path: "/public/assets/kaykit/characters/adventurers/knight.glb",
  ...
  },
  {
    ...
    team: "antimicrobial",
    kind: "animated-character",
    path: "/public/assets/kaykit/characters/adventurers/barbarian.glb",
    sourcePack: "KayKit Character Pack Adventures",
    defaultScale: 1,
    facingRotation: -Math.PI / 2,
  ...
  },
  {
    ...
    team: "antimicrobial",
    kind: "animated-character",
    path: "/public/assets/kaykit/characters/adventurers/mage.glb",
    sourcePack: "KayKit Character Pack Adventures",
    defaultScale: 1,
    facingRotation: -Math.PI / 2,
  ...
  },
  {
    ...
    team: "bacteria",
    kind: "animated-character",
    path: "/public/assets/kaykit/characters/skeletons/skeleton_minion.glb",
  ...
  },
  {
    ...
    team: "bacteria",
    kind: "animated-character",
    path: "/public/assets/kaykit/characters/skeletons/skeleton_warrior.glb",
    sourcePack: "KayKit Character Pack Skeletons",
    defaultScale: 1,
    facingRotation: Math.PI / 2,
  ...
  },
  {
    ...
    team: "environment",
    kind: "environment",
    path: "/public/assets/kaykit/environment/terrain/hex_grass.gltf",
  ...
  },
  {
    ...
    team: "environment",
    kind: "prop",
    path: "/public/assets/kaykit/environment/flags/flag_blue.gltf",
    sourcePack: "KayKit Medieval Hexagon Pack",
    defaultScale: 1,
    facingRotation: 0,
    expectedClips: []
  },
  {
    ...
    team: "environment",
    kind: "prop",
    path: "/public/assets/kaykit/environment/flags/flag_red.gltf",
    sourcePack: "KayKit Medieval Hexagon Pack",
    defaultScale: 1,
    facingRotation: 0,
    expectedClips: []
  },
  {
    ...
    team: "environment",
    kind: "prop",
    path: "/public/assets/kaykit/environment/rocks/rock_single_a.gltf",
    sourcePack: "KayKit Medieval Hexagon Pack",
    defaultScale: 1,
    facingRotation: 0,
    expectedClips: []
  },
  {
    ...
    team: "environment",
    kind: "prop",
    path: "/public/assets/kaykit/environment/vegetation/tree_single_a_cut.gltf",
    sourcePack: "KayKit Medieval Hexagon Pack",
    defaultScale: 1,
    facingRotation: 0,
    expectedClips: []
